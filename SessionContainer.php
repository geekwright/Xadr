 ...
 *
 * We may have multiple xadr based modules, as well as multiple
 * invocations of the controller in a single transaction (i.e. xadr
 * blocks,) we will segregate our session data by XOOPS module
 * by including the module name in the name.
 *
 * @category  Xmf\Xadr\SessionContainer
 * @package   Xmf
...
class SessionContainer extends ContextAware implements Container
{
     ...
     *
     * Include XOOPS module so we don't mix context between Xadr modules.
     *
